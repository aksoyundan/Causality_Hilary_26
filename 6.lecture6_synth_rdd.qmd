...
$X_i$ and $X_0W$. `R` coses $v$ so that **Root mean Squared Prediction Error (RMSPE)** is minimised where
...
2. Treat unit's counterfactual is a weighted linear combination of control units (convex hull)
...
* Lots of data is preferable before the treatment
